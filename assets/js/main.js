...
// Section
const movieOutputWrapper = document.querySelector(".movie__output__wrapper");

// Globale Error Ausgabe, auf die viele Funktionen zugreifen
...
const newArticle = (elem) => {
	...
	newArticle.innerHTML += `<p><span>Regisseur:</span><br> ${elem[2]}</p>`;
	newArticle.innerHTML += `<p><span>Running Time:</span><br>${elem[3]} &#128337;</p>`;
	newArticle.innerHTML += `<p><span>Genre:</span><br> ${elem[4].join(
		" • "
	)}</p>`;
	newArticle.innerHTML += `<p><span>Rating:</span> ${elem[5]} \u2605</p>`;
	movieOutputWrapper.appendChild(newArticle).classList.add("output");
};
